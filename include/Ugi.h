...
typedef void LoggingDestination(NSString * _Nonnull s, NSObject * _Nullable param);
 ...
 */
- (void) setLoggingDestination:(nonnull LoggingDestination *)loggingDestination
                     withParam:(nullable NSObject *)param;
